    ...
    >
      <Toolbar
        ...
        sx={{
          ...
          minHeight: (theme: any) => `${theme.mixins.toolbar.minHeight as number}px !important`,
          backgroundColor: (theme: any) => hexToRGBA(theme.palette.background.paper, appBarBlur ? 0.95 : 1),
          ...(skin === 'bordered' ? {border: (theme: any) => `1px solid ${theme.palette.divider}`} : {boxShadow: 2}),
          ...(contentWidth === 'boxed' && {
            '@media (min-width:1440px)': {maxWidth: (theme: any) => `calc(1440px - ${theme.spacing(6 * 2)})`},
          }),
        }}
      >
